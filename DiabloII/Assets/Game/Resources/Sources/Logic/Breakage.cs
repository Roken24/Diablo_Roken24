...
public static class Breakage
{
    ...
    public static void Update(Transform trans)
    {
        ...
        Transform t22 = trans.Find("breakage_22");
        t22.gameObject.SetActive(true);
        Transform t23 = trans.Find("breakage_23");
        t23.gameObject.SetActive(true);
        Transform t24 = trans.Find("breakage_24");
        t24.gameObject.SetActive(true);
        Transform t25 = trans.Find("breakage_25");
        t25.gameObject.SetActive(true);
        Transform t26 = trans.Find("breakage_26");
        t26.gameObject.SetActive(true);
        Transform t27 = trans.Find("breakage_27");
        t27.gameObject.SetActive(true);
        Transform t28 = trans.Find("breakage_28");
