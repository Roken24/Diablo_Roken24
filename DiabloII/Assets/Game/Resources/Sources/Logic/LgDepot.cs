...
public class LgDepot : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        Transform node = transform.Find("Camera/Anchor/Panel/Contain/RepairGold");
    ...
    private void UpdateGold()
    {
        ...
        Transform root = transform.Find("Camera/Anchor/Panel/Contain/Gold");
    ...
    void OnClickTip(GameObject obj)
    {
        ...
        if (selectedTile != obj)
        {
            ...
            if (Config.DataLoader.equipmentMaps.ContainsKey(eid))
            {
                ...
                Transform node = root.Find("SetupBtn");
                ...
                {
                    node.Find("Label").GetComponent<UILabel>().text = "打 开";
                }
                else
                {
                    node.Find("Label").GetComponent<UILabel>().text = "穿 戴";
                }
            }
