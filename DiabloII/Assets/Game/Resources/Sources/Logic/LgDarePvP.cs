...
public class LgDarePvP : MonoBehaviour
{
    ...
    void Start()
    {
        UISprite sp = transform.Find("Camera/Anchor/Panel/Battle/MyInfo/Icon").GetComponent<UISprite>();
        ...
        sp = transform.Find("Camera/Anchor/Panel/Battle/TargetInfo/Icon").GetComponent<UISprite>();
    ...
    void OnEnd(bool win)
    {
        ...
        Transform trans = transform.Find("Camera/Anchor/Panel/Battle/Mark");
        trans.gameObject.SetActive(true);
        UILabel mark = trans.Find("Label").GetComponent<UILabel>();
        mark.text = win ? "胜  \n  利" : "失  \n  败";

        mark = trans.Find("Rank").GetComponent<UILabel>();
    ...
    private void InitUIComponent()
    {
        ...
        Transform node = transform.Find(root + "HPBar");
