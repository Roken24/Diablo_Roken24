...
public class LgFighting : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        atlasRoot = transform.Find("Camera/Anchor/Panel/Tile").GetComponent<UISprite>().atlas;
        ...
        Transform t = transform.Find("Camera/Anchor/Panel/Battle/AccBtn");
    ...
    {
        Transform trans = transform.Find("Camera/Anchor/Panel/Splash/Node");
    ...
    void OnStart()
    {
        ...
        Transform trans = transform.Find("Camera/Anchor/Panel/Battle");
        ...
        trans = transform.Find("Camera/Anchor/Panel/Battle/SenceName");
    ...
    private void InitUIComponent()
    {
        if (nameLab == null)
        {
            ...
            Transform node = transform.Find(root + "MName");
            nameLab = node.GetComponent<UILabel>();

            node = transform.Find(root + "MLevel");
            lvlLab = node.GetComponent<UILabel>();

            node = transform.Find(root + "HPBar");
            mHpProgress = node.GetComponent<UISlider>();

            node = transform.Find(root + "Monster");
            iconTex = node.GetComponent<UISprite>();

            node = transform.Find("Camera/Anchor/Panel/Battle/FightingMsg");
            content = node.GetComponent<UITextList>();

            node = transform.Find("Camera/Anchor/Panel/Battle/ExpBar");
            expProgress = node.GetComponent<UISlider>();

            node = transform.Find("Camera/Anchor/Panel/Battle/HpBar");
            pHpProgress = node.GetComponent<UISlider>();

            node = transform.Find("Camera/Anchor/Panel/Battle/SumGold");
