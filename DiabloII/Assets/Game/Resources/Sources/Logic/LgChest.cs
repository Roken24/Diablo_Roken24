...
public class LgChest : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        sprite = transform.Find("Camera/Anchor/Panel/Equipment").GetComponent<UISprite>();
    ...
    IEnumerator OnAnimFinish(bool taken, Config.Equipment eq)
    {
        ...
        GameObject.DestroyImmediate(transform.Find("Camera/Anchor/Panel/Anim").gameObject);
