...
public class LgTask : MonoBehaviour
{
    ...
    void Start()
    {
        tabNode = this.transform.Find("Camera/Anchor/Panel/Tab");

        for (int i = 0; i < 5; i++)
        {
            Transform node = transform.Find("Camera/Anchor/Panel/Tg" + (i + 1));
    ...
    private void SelectTab(int tab)
    {
        ...
        for (; i < tasks.Count; i++)
        {
            Transform t = tabNode.Find("T" + (i + 1));
            ...
            t = btn.transform.Find("Background");
    ...
    {
        Transform t = btn.transform.Find("Sprite");
        t.gameObject.SetActive(true);

        for (int i = 1; i < 7; i++)
        {
            Transform tm = btn.transform.parent.Find("T" + i + "/Sprite");
            if (tm != t)
    ...
    void OnSetContent(GameObject o)
    {
        ...
        Transform t = transform.Find("Camera/Anchor/Panel/Text/Label");
        UILabel lab = t.GetComponent<UILabel>();

        t = transform.Find("Camera/Anchor/Panel/PassedButton");
